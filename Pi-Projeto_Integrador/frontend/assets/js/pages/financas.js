...
const despesasMesContent = document.getElementById(
  "despesas-ganhos-mes-content"
);
const despesasAnoBtn = document.getElementById("despesas-ganhos-ano-btn");
const despesasAnoContent = document.getElementById(
  "despesas-ganhos-ano-content"
);
...
despesasMesBtn.addEventListener("click", () => {
  mainContent.classList.add("hidden");
  despesasMesContent.classList.remove("hidden");
});

despesasAnoBtn.addEventListener("click", () => {
  mainContent.classList.add("hidden");
  despesasAnoContent.classList.remove("hidden");
});

graficoLucroBtn.addEventListener("click", () => {
  mainContent.classList.add("hidden");
  graficoLucroContent.classList.remove("hidden");
});
