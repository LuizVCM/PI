...
export class UserService {
    ...
    async listByIdwithSeed(id: number) {
        return await UserRepository.findByIdWithSemente(id)
    }
    async listByIdwithTerritorio(id: number) {
        return await UserRepository.findByIdWithTerritorio(id)
    }
    async listByIdwithFinanca(id: number) {
        return await UserRepository.findByIdWithFinancas(id)
    }
